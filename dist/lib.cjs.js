...
var RubberBand = /** @class */ (function (_super) {
    ...
    RubberBand.prototype.render = function () {
        ...
        return (React__default['default'].createElement("svg", { id: "Rubberband", className: "rubberBand-Container", width: "100%", height: "100%", onMouseDown: function (event) {
                _this.props.doRubberMouseDown(event, Consts.MODE_RUBER_BAND_MOVE);
            } },
            React__default['default'].createElement("g", { transform: "matrix(" + coordinates.transform + ")" },
                React__default['default'].createElement("rect", { className: "rubberBand", x: coordinates.x, y: coordinates.y, width: coordinates.w, height: coordinates.h }),
                React__default['default'].createElement("rect", { className: "rubberBandHandle", x: coordinates.x - Consts.RUBBER_BAND_HANDLE_SIZE, y: coordinates.y - Consts.RUBBER_BAND_HANDLE_SIZE, width: Consts.RUBBER_BAND_HANDLE_SIZE, height: Consts.RUBBER_BAND_HANDLE_SIZE, onMouseDown: function (event) {
                        _this.props.doRubberMouseDown(event, Consts.MODE_RUBER_BAND_RESIZE_UL);
                    } }),
                React__default['default'].createElement("rect", { className: "rubberBandHandle", x: coordinates.x + coordinates.w, y: coordinates.y - Consts.RUBBER_BAND_HANDLE_SIZE, width: Consts.RUBBER_BAND_HANDLE_SIZE, height: Consts.RUBBER_BAND_HANDLE_SIZE, onMouseDown: function (event) {
                        _this.props.doRubberMouseDown(event, Consts.MODE_RUBER_BAND_RESIZE_UR);
                    } }),
                React__default['default'].createElement("rect", { className: "rubberBandHandle", x: coordinates.x - Consts.RUBBER_BAND_HANDLE_SIZE, y: coordinates.y + coordinates.h, width: Consts.RUBBER_BAND_HANDLE_SIZE, height: Consts.RUBBER_BAND_HANDLE_SIZE, onMouseDown: function (event) {
                        _this.props.doRubberMouseDown(event, Consts.MODE_RUBER_BAND_RESIZE_DL);
                    } }),
                React__default['default'].createElement("rect", { className: "rubberBandHandle", x: coordinates.x + coordinates.w, y: coordinates.y + coordinates.h, width: Consts.RUBBER_BAND_HANDLE_SIZE, height: Consts.RUBBER_BAND_HANDLE_SIZE, onMouseDown: function (event) {
                        _this.props.doRubberMouseDown(event, Consts.MODE_RUBER_BAND_RESIZE_DR);
                    } }),
                React__default['default'].createElement("rect", { className: "rubberBandHandle", x: coordinates.x + coordinates.w / 2 - Consts.RUBBER_BAND_HANDLE_SIZE, y: coordinates.y + coordinates.h * 1.5, width: Consts.RUBBER_BAND_HANDLE_SIZE, height: Consts.RUBBER_BAND_HANDLE_SIZE, onMouseDown: function (event) {
...
var ViewPortElement = /** @class */ (function (_super) {
    ...
    ViewPortElement.prototype.render = function () {
        ...
        return (React__default['default'].createElement("div", { id: "" + this.props.id, style: {
                overflow: 'hidden',
                transformOrigin: '0% 0%',
                top: 0,
                left: 0,
...
var ZoomPan = /** @class */ (function (_super) {
    ...
    function ZoomPan(props) {
        ...
        _this.renderChildren = function () {
            ...
            return React__default['default'].Children.map(children, function (item, i) {
                var transform = selection.id == i ? selection.transform : null;
                var box = selection.id == i ? selection.box : null;
                return (React__default['default'].createElement(ViewPortElement, { id: i.toString(), key: i, transform: transform, box: box, doObjectMouseDown: _this.doObjectMouseDown }, item));
            });
        };
        //Init Controllers
    ...
    ZoomPan.prototype.render = function () {
        ...
        return (React__default['default'].createElement("div", { ref: this.containerRef, className: "zoom-pan-container", onDragOver: this.onDragOver, onDrop: this.onDrop, tabIndex: 0 },
            React__default['default'].createElement("div", { id: "viewport", style: { position: 'relative', userSelect: 'none', height: '100%' }, onMouseDown: this.doGlobalMouseDown, onWheel: this.doMouseWheel },
                React__default['default'].createElement("div", { style: {
                        transform: "matrix(" + viewportTr + ")",
                        position: 'absolute',
                    } }, this.renderChildren()),
                React__default['default'].createElement(RubberBand, { selection: this.selection, viewport: this.state, doRubberMouseDown: this.doRubberMouseDown }))));
    };
    return ZoomPan;
}(React__default['default'].Component));
